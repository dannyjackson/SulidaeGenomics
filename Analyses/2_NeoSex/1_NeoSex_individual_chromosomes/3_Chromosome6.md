...
```
VCF=/xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_wg/vcfs/chroms/CM062572.1.qualitysort_filtered_mind2.vcf
...
```
Rscript 3a_chr6_pi.r
```
### SNP Density
Set up working directory and environment
```
cd /xdisk/mcnew/dannyjackson/sulidae/analyses/neosex_inference
mkdir -p snpdensity_chr6
cd snpdensity_chr6
...
```
VCF="/xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_wg/vcfs/chroms/CM062572.1.qualitysort_filtered_mind2.vcf.gz"
...
```
Rscript 3c_chr6_heterozygsosity.r
```