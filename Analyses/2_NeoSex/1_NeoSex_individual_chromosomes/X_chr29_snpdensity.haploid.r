cd /xdisk/mcnew/dannyjackson/sulidae/analyses/snpdensity/haploid/chr29
# visualize the density of snps
VCF="/xdisk/mcnew/dannyjackson/sulidae/analyses/neosex_haploid/29_haploid.qualitysort.vcf.gz"
...
# ---- save (optional) ----
ggsave("snp_density_by_sex.faceted.chr29.haploid.png", p, width = 12, height = 3, dpi = 300)
