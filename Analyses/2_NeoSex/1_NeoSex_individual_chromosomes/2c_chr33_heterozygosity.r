...
# Bin positions to 10 kp windows
hets <- long |>
  mutate(
    het = is_het(GT),
...
p <- ggplot(hets_sex,
  ...
  labs(
    title = paste0("Z Chromosome (10 kb bins)"),
...
ggsave(paste0(OUT, ".hets_10kb.pdf"), p, width = 12, height = 3, dpi = 300)
...
ggsave(paste0(OUT, ".hets_10kb.faceted.pdf"), width = 12, height = 8, dpi = 300)
