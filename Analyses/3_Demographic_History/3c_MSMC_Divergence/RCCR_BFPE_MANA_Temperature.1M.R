...
ggsave("RCCR_temp_BFBO_PEBO_MABO_NABO_stacked.png", p_stack, width = 7, height = 5)
ggsave("RCCR_temp_BFBO_PEBO_MABO_NABO_stacked.pdf", p_stack, width = 7, height = 5)
