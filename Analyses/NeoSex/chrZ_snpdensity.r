cd /xdisk/mcnew/dannyjackson/sulidae/analyses/snpdensity/chrZ
...
p <- ggplot(dat, aes(x = BIN_START, y = SNP_COUNT,
  ...
  labs(x = "Position (bp)", y = "SNPs per 1000 kb", color = "Sex") +
...
# ---- save (optional) ----
ggsave("snp_density_by_sex.faceted.chrZ.png", p, width = 12, height = 3, dpi = 300)
