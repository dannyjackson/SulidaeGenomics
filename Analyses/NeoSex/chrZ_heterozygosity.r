...
# inputs
cp /xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_wg/vcfs/chroms/CM062600.1.qualitysort_filtered_mind2.vcf /xdisk/mcnew/dannyjackson/sulidae/analyses/snpdensity/

VCF=/xdisk/mcnew/dannyjackson/sulidae/analyses/snpdensity/CM062600.1.qualitysort_filtered_mind2.vcf        # bgzipped + indexed VCF
# VCF=/xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_wg/vcfs/Sula_MorusBassanus_snps_multiallelic.contigs.qualitysort.vcf
CHR=CM062600.1       # chromosome/scaffold name
...
ggsave("pi.CM062600.1.allindv.png", width = 12, height = 24, dpi = 300)


### Per individual heterozygosity
# --- inputs you edit ---
CHR=CM062600.1                    # chromosome/scaffold to plot (change as needed)
...
p <- ggplot(hets_sex,
  ...
  labs(
    title = paste0("Z Chromosome (1000 kb bins)"),
