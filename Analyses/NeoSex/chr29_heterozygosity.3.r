...
# Read GFF PC
genesPC <- read_tsv("chr29.PC.genes.gff", comment = "#", col_names = FALSE)
...
genesMB <- read_tsv("chr29.MB.genes.gff", comment = "#", col_names = FALSE)
...
# Read GFF RE
genesRE <- read_tsv("chr29.RE.gff", comment = "#", col_names = FALSE)
...
merged_path_snp <- "/xdisk/mcnew/dannyjackson/sulidae/analyses/snpdensity/chr29/merged.snpden.tsv"
