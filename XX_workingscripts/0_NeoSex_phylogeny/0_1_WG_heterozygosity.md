# Compute heterozygosity across the entire genome to infer which microchromosome is a neo sex chromosome
```
cd /xdisk/mcnew/dannyjackson/sulidae/datafiles/bamstats/sexing_by_heterozygosity_filtered/hetplot_allchr

module load samtools htslib bcftools

VCF=/xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_wg/vcfs/Sula_MorusBassanus.qualitysort_filtered_mind2.vcf.gz        # bgzipped + indexed VCF
...
Rscript allchr_heterozygosity.sh
```

# Rscript all_heterozygosity.1.sh
#!/usr/bin/env bash
...
cd /xdisk/mcnew/dannyjackson/sulidae/datafiles/bamstats/sexing_by_heterozygosity_filtered/hetplot_allchr/
Rscript 1a_WG_heterozygosity.r
