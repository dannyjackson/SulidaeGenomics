...
VCF_DIR=/xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_windows_5kb_snp/Zphylogeny/vcfs
OUTDIR=/xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_windows_5kb_snp/Zphylogeny/windows
...
OUTDIR=/xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_windows_5kb_snp/Zphylogeny/windows/ParGene_10SNP/
msa_dir=/xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_windows_5kb_snp/Zphylogeny/windows/phy_noINV
...
find /xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_windows_5kb_snp/Zphylogeny/windows/ParGene_10SNP/mlsearch_run/results -name "*.bestTree" \
  -exec awk '{printf "%s\n", $0}' {} \; > allbesttrees.10SNP.tre

nw_ed  allbesttrees.10SNP.tre 'i & b<=10' o > allbesttrees-BS10.10SNP.tre


java -jar ~/programs/ASTRAL/Astral/astral.5.7.8.jar \
  -i allbesttrees-BS10.10SNP.tre \
...
find /xdisk/mcnew/dannyjackson/sulidae/analyses/raxml_windows_5kb_snp/Zphylogeny/windows/ParGene/mlsearch_run/results -name "*.bestTree" \
  -exec awk '{printf "%s\n", $0}' {} \; > allbesttrees.txt
